...
public final class ShulkerBoxTooltip implements ModInitializer, ShulkerBoxTooltipApi {
   ...
   */
  public static final ImmutableList<Item> SHULKER_BOX_ITEMS =
      ImmutableList.of(Items.SHULKER_BOX, Items.WHITE_SHULKER_BOX, Items.ORANGE_SHULKER_BOX,
  ...
  public static void initPreviewItemsMap() {
    if (previewItems == null) {
      List<ShulkerBoxTooltipApi> plugins = FabricLoader.getInstance()
